package Work02.Unit05.InfoSystem;
...
import static Work02.Unit05.InfoSystem.EmployeeManagement.mainEmployee;
...
class EmployeeManagement {
    ...
    public static void mainEmployee() {
        ...
        try {
            f = new File("C:\\Users\\sivvi\\Java\\Example_Java\\HomeWork\\src\\Work02\\Unit05\\InfoSystem\\Data\\EmployeeDataList.csv");
            if (f.exists()) {
        ...
        do {
            ...
            switch (ch) {
                ...
                case 2:
                    System.out.println("Введите правильный вариант из списка :");
                    id = sc.nextInt();
                    int i = 0;
                    for (Employee e : al) {
                        if (id == e.id) {
                        ...
                        if (id == e.id) {
                            ...
                            do {
                                ...
                                switch (ch1) {
                                    ...
                                    case 4:
                                        System.out.println("Введите новый контактный номер сотрудника :");
                                        e.contact_no = sc.nextLong();
                                        System.out.println(e + "\n");
                                        break;

                                    case 5:
                                        System.out.println("Введите новый адрес электронной почты сотрудника :");
                                        e.email_id = sc.next();
                                        System.out.println(e + "\n");
                                        break;
